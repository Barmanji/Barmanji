# 💫 About Me:
🔥 My Skills- <br>    Languages: JavaScript, TypeScript, Python<br>    Frameworks/Libraries: React, React Router, Redux, Express.js, Next.js<br>    Styling: Tailwind, Shadcn, Aceternity<br>    Tools & Workflow: Git, GitHub CLI, npm/yarn, VIM<br>

## 🌐 Socials:
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/ajay-barman-0b37011a7/) [![X](https://img.shields.io/badge/X-black.svg?logo=X&logoColor=white)](https://x.com/ItsBarmanji) 
